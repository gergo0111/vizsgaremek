...
export function UserPatch() {
        ...
        const handleChange = (field: keyof User, value: any) => {
            setUser(prev => {
                const base = prev ?? { user_id: Number(user_id) || 0, felhasznalonev: '', email: '', jelszo: '', nev: '', munkakor: '', munkaora: 0, isActice: false, isAdmin: false };
            ...
            return <>
                     ...
                     <form onSubmit={saveUser}>
                        ...
                        <div>
                              ...
                              <input type="password" value={user.jelszo} name="jelszo"/>
                              <button onClick={() => navigate("folyamatban...")}>✏️</button>
                        </div>
                        <div>
                              <label>Név: </label> <br />
